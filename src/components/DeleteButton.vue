<template>
  ...
  <Transition name="fade">
    <div id="deleteModal" tabindex="-1" v-if="isDelete"  class="grid place-items-center h-full top-0 sm:h-full right-0 md:right-auto md:top-auto overflow-y-auto bg-black/50 backdrop-blur-sm overflow-x-hidden fixed z-50 justify-center items-center w-full md:inset-0 md:h-full">
